...
<div id="content">
    ...
    $menu .="<li><a href=\"#\">archive</a></li>";
    $menu .="<li><a href=\"#\">contact</a></li></ul>";
    echo $menu;
    ?>
    ...
    <div class="post">
        <div class="details">
            <?
            echo "<h2><a href=\"#\">Nunc commodo euismod massa quis vestibulum</a></h2>";
            echo "<p class=\"info\">posted 3 hours ago in <a href=\"#\">general</a></p>";
            ?>
        </div>
        <div class="body">
            <?
            echo "<p>Nunc eget nunc libero. Nunc commodo euismod massa quis vestibulum. Proin mi nibh, dignissim a
    ...
    <div class="col">
        <?
        echo "<h3><a href=\"#\">Ut enim risus rhoncus</a></h3>";
        echo "<p>Quisque consectetur odio ut sem semper commodo. Maecenas iaculis leo a ligula euismod condimentum. Cum sociis
    ...
    <div class="col">
        <?
        echo "<h3><a href=\"#\">Maecenas iaculis leo</a></h3>";
        echo "<p>Quisque consectetur odio ut sem semper commodo. Maecenas iaculis leo a ligula euismod condimentum. Cum sociis
            natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Ut enim risus, rhoncus sit amet
            ultricies vel, aliquet ut dolor. Duis iaculis urna vel massa ultricies suscipit. Phasellus diam sapien,
            fermentum a eleifend non, luctus non augue. Quisque scelerisque purus quis eros sollicitudin gravida.
    ...
    <div class="col last">
        <?
        echo "<h3><a href=\"#\">Quisque consectetur odio</a></h3>";
        echo "<p>Quisque consectetur odio ut sem semper commodo. Maecenas iaculis leo a ligula euismod condimentum. Cum sociis
            natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Ut enim risus, rhoncus sit amet
            ultricies vel, aliquet ut dolor. Duis iaculis urna vel massa ultricies suscipit. Phasellus diam sapien,
            fermentum a eleifend non, luctus non augue. Quisque scelerisque purus quis eros sollicitudin gravida.
    ...
    <div id="footer">
        <?
        echo "<p>Copyright &copy; <em>minimalistica</em> &middot; Design: Luka Cvrk, <a href=\"http://www.solucija.com/\" title=$title>Solucija</a></p>";
        echo "$d";
        ?>
    </div>
</div>
